...
function custom_post() {
	...
	register_post_type( 'Members', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			...
			'new_item' => __( 'New Members', 'bonestheme' ), /* New Display Title */
			...
			'description' => __( 'This is a member', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
			...
			'rewrite'	=> array( 'slug' => 'members', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'members', /* you can rename the slug here */
	...
	register_post_type( 'News & Events', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		// let's now add all the options for this post type
		array( 'labels' => array(
			'name' => __( 'News & Events', 'bonestheme' ), /* This is the Title of the Group */
			'singular_name' => __( 'News/Event', 'bonestheme' ), /* This is the individual type */
			'all_items' => __( 'All News & Events', 'bonestheme' ), /* the all items menu item */
			'add_new' => __( 'Add New', 'bonestheme' ), /* The add new menu item */
			'add_new_item' => __( 'Add New News or Event', 'bonestheme' ), /* Add New Display Title */
			'edit' => __( 'Edit', 'bonestheme' ), /* Edit Dialog */
			'edit_item' => __( 'Edit News & Events', 'bonestheme' ), /* Edit Display Title */
			'new_item' => __( 'New News or Event', 'bonestheme' ), /* New Display Title */
			'view_item' => __( 'View News/Event', 'bonestheme' ), /* View Display Title */
			'search_items' => __( 'Search News & Events', 'bonestheme' ), /* Search Custom Type Title */
			'not_found' =>  __( 'Nothing found in the Database.', 'bonestheme' ), /* This displays if there are no entries yet */
			'not_found_in_trash' => __( 'Nothing found in Trash', 'bonestheme' ), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'This is an event', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
			'publicly_queryable' => true,
			'exclude_from_search' => false,
			'show_ui' => true,
			...
			'rewrite'	=> array( 'slug' => 'News & Events', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'News & Events', /* you can rename the slug here */
			'capability_type' => 'post',
			'hierarchical' => false,
			/* the next one is important, it tells what's enabled in the post editor */
			'supports' => array( 'title', 'editor', 'author', 'thumbnail', 'excerpt', 'trackbacks', 'custom-fields', 'comments', 'revisions', 'sticky')
